...
// AUTO-GENERATED on Sun, 29 Jun 2014 09:58:19 GMT
    ...
    public static class Skills
    {
        ...
        public static List<Skill> AllSkills
        {
            get
            {
                if (!_allSkills.Any())
                {
                    _allSkills.AddRange(Barbarian.ToList());
                    _allSkills.AddRange(WitchDoctor.ToList());
                    _allSkills.AddRange(DemonHunter.ToList());
                    _allSkills.AddRange(Wizard.ToList());
                    _allSkills.AddRange(Crusader.ToList());
                    _allSkills.AddRange(Monk.ToList());
                }                
                return _allSkills;
            }
        }
        ...
        /// </summary>
        public static Skill GetSkillBySNOPower (SNOPower power)
        {
            if (!_allSkillBySnoPower.Any())
            {
                _allSkillBySnoPower = _allSkills.ToDictionary(s => s.SNOPower, s => s);
            }
            Skill skill;
        ...
        /// All SNOPowers
        /// </summary>        
        public static HashSet<SNOPower> AllSNOPowers
        {
            get { return _allSNOPowers ?? (_allSNOPowers = new HashSet<SNOPower>(AllSkills.Select(s => s.SNOPower))); }
        }
        ...
        public static List<Skill> ActiveSkills
        {
            get
            {                
                if (!_activeSkills.Any() || ShouldUpdateActiveSkills)
                    UpdateActiveSkills();
        ...
        /// </summary>
        public static HashSet<SNOPower> ActiveSkillsSNOPowers
        {
            get
            {
                if (!_activeSkillsSNOPowers.Any() || ShouldUpdateActiveSkills)
                    UpdateActiveSkills();

                return _activeSkillsSNOPowers;
            }
        }
        private static HashSet<SNOPower> _activeSkillsSNOPowers = new HashSet<SNOPower>();
        ...
        private static void UpdateActiveSkills()
        {
            ...
            _activeSkills = CurrentClassSkills.Where(s => HotbarSkills.AssignedSNOPowers.Contains(s.SNOPower)).ToList();
            _activeSkillsSNOPowers = HotbarSkills.AssignedSNOPowers;
        }
        ...
        {
            get { return DateTime.UtcNow.Subtract(_lastUpdatedActiveSkills) > TimeSpan.FromSeconds(5); }
        } 

        /// <summary>
        /// All possible skills, as SNOPower
        /// </summary>        
        public static HashSet<SNOPower> CurrentClassSNOPowers
        {
            get { return new HashSet<SNOPower>(CurrentClassSkills.Select(s => s.SNOPower)); }
        }
        ...
        /// </summary>
        public static IEnumerable<Skill> CurrentClassSkills
        {
        ...
        {
            var firstOrDefault = GetSkillBySNOPower(power).Runes.FirstOrDefault(r => r.RuneIndex == dbRuneIndex);
        ...
        {
            var firstOrDefault = GetSkillBySNOPower(power).Runes.FirstOrDefault(r => r.Index == properRuneIndex);
