...
// AUTO-GENERATED on Thu, 16 Apr 2015 06:52:06 GMT
    ...
    public static class Runes
    {
        public class WitchDoctor : FieldCollection<WitchDoctor, Rune>
        {
            ...
            public static Rune SoulToWaste = new Rune
            {
                ...
                RuneIndex = 1,
                SkillIndex = 6,
                ModifiedDuration = TimeSpan.FromSeconds(60),
                Class = ActorClass.Witchdoctor
            };
            ...
            public static Rune CloudOfInsects = new Rune
            {
                ...
                RuneIndex = 2,
                SkillIndex = 14,
                ModifiedDuration = TimeSpan.FromSeconds(16),
                ModifiedIsDamaging = true,
                Class = ActorClass.Witchdoctor
            };
            ...
            /// <summary>
            /// Increases the magnitude of the hex to 20% additional damage.
            /// </summary>
            public static Rune Jinx = new Rune
            {
                Index = 2,
                Name = "Jinx",
                Description = "Increases the magnitude of the hex to 20% additional damage.",
                Tooltip = "rune/hex/e",
                TypeId = "e",
                RuneIndex = 4,
                SkillIndex = 16,
        ...
        public class Barbarian : FieldCollection<Barbarian, Rune>
        {
            ...
            /// <summary>
            /// Gain 25% movement speed while under the effects of Frenzy.
            /// </summary>
            public static Rune Vanguard = new Rune
            {
                Index = 3,
                Name = "Vanguard",
                Description = "Gain 25% movement speed while under the effects of Frenzy.",
            ...
            public static Rune Ferocity = new Rune
            {
                ...
                RuneIndex = 1,
                SkillIndex = 17,
                ModifiedDuration = TimeSpan.FromSeconds(300),
                Class = ActorClass.Barbarian
            };
        ...
        public class DemonHunter : FieldCollection<DemonHunter, Rune>
        {
            ...
            /// <summary>
            /// Increase the damage of each explosion to 420% weapon damage and turns the damage into Cold.
            /// </summary>
            public static Rune EchoingBlast = new Rune
            {
                Index = 1,
                Name = "Echoing Blast",
                Description = "Increase the damage of each explosion to 420% weapon damage and turns the damage into Cold.",
