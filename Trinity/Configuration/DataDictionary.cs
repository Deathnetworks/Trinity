...
namespace Trinity
{
    ...
    internal class DataDictionary
    {
        ...
        private static readonly Dictionary<SNOAnim, Anim> avoidAnimationsIds = new Dictionary<SNOAnim, Anim>
        {
            ...
            { SNOAnim.arcaneEnchantedAvengerDummy_turnLeft, new Anim(SNOAnim.arcaneEnchantedAvengerDummy_turnLeft, AvoidType.Attack, Element.Physical) },
            { SNOAnim.arcaneEnchantedDummy_60ft_base, new Anim(SNOAnim.arcaneEnchantedDummy_60ft_base, AvoidType.Attack, Element.Physical) },
            { SNOAnim.arcaneEnchantedDummy_60ft_turnLeft, new Anim(SNOAnim.arcaneEnchantedDummy_60ft_turnLeft, AvoidType.RotateLeft, Element.Physical) },
            { SNOAnim.arcaneEnchantedDummy_60ft_turnRight, new Anim(SNOAnim.arcaneEnchantedDummy_60ft_turnRight, AvoidType.RotateRight, Element.Physical) },
            { SNOAnim.arcaneEnchantedDummy_turnLeft, new Anim(SNOAnim.arcaneEnchantedDummy_turnLeft, AvoidType.RotateLeft, Element.Physical) },
            { SNOAnim.arcaneEnchantedDummy_turnRight, new Anim(SNOAnim.arcaneEnchantedDummy_turnRight, AvoidType.RotateRight, Element.Physical) },
