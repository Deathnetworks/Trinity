...
namespace Trinity.Items
{
    ...
    public class Item
    {
        ...
        public bool IsBuffActive
        {
            ...
            {          
                ...
                // Item Creates Buff
                SNOPower power;
                if (Lookup.ItemAndSNOPower.TryGetValue(this, out power))
                    return  CombatBase.GetHasBuff(power);

                // Item Spawns Minions
                string internalNameToken;
                if (Lookup.ItemAndMinionInternalNameToken.TryGetValue(this, out internalNameToken))
    ...
    public class Lookup
    {
        ...
        public readonly static Dictionary<Item, string> ItemAndMinionInternalNameToken = new Dictionary<Item, string>
        {
