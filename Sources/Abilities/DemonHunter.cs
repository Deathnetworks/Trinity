    ...
    public partial class GilesTrinity : IPlugin
    {
        private static TrinityPower GetDemonHunterPower(bool bCurrentlyAvoiding, bool bOOCBuff, bool bDestructiblePower)
        {
            ...
            if (!bOOCBuff && Hotbar.Contains(SNOPower.DemonHunter_ShadowPower) && !playerStatus.IsIncapacitated &&
                ...
                (playerStatus.CurrentHealthPct <= 0.99 || playerStatus.IsRooted || ElitesWithinRange[RANGE_25] >= 1 || iAnythingWithinRange[RANGE_15] >= 3) &&
            ...
            if ((!bOOCBuff || Settings.Combat.DemonHunter.SpamSmokeScreen) && Hotbar.Contains(SNOPower.DemonHunter_SmokeScreen) &&
                ...
                (
                 ( playerStatus.CurrentHealthPct <= 0.90 || playerStatus.IsRooted || ElitesWithinRange[RANGE_20] >= 1 || iAnythingWithinRange[RANGE_15] >= 3 || playerStatus.IsIncapacitated ) ||
            ...
            if (!bOOCBuff && !playerStatus.IsIncapacitated && Hotbar.Contains(SNOPower.DemonHunter_Sentry) &&
                (ElitesWithinRange[RANGE_50] >= 1 || iAnythingWithinRange[RANGE_50] >= 2 ||
            ...
            if (!bOOCBuff && !bCurrentlyAvoiding && Hotbar.Contains(SNOPower.DemonHunter_MarkedForDeath) &&
                ...
                (ElitesWithinRange[RANGE_40] >= 1 || iAnythingWithinRange[RANGE_40] >= 3 ||
            ...
            if (!bOOCBuff && Hotbar.Contains(SNOPower.DemonHunter_RainOfVengeance) && !playerStatus.IsIncapacitated &&
                (iAnythingWithinRange[RANGE_25] >= 3 || ElitesWithinRange[RANGE_25] >= 1) &&
            ...
            if (!bOOCBuff && !bCurrentlyAvoiding && Hotbar.Contains(SNOPower.DemonHunter_ClusterArrow) && !playerStatus.IsIncapacitated &&
               ...
               (ElitesWithinRange[RANGE_50] >= 1 || iAnythingWithinRange[RANGE_50] >= 5 || ((CurrentTarget.IsEliteRareUnique || CurrentTarget.IsTreasureGoblin || CurrentTarget.IsBoss) && CurrentTarget.RadiusDistance <= 69f)) &&
            ...
            if (!bOOCBuff && !bCurrentlyAvoiding && Hotbar.Contains(SNOPower.DemonHunter_Multishot) && !playerStatus.IsIncapacitated &&
                ...
                (ElitesWithinRange[RANGE_40] >= 1 || iAnythingWithinRange[RANGE_40] >= 2 || ((CurrentTarget.IsEliteRareUnique || CurrentTarget.IsTreasureGoblin || CurrentTarget.IsBoss) && 
            ...
            if (!bOOCBuff && Hotbar.Contains(SNOPower.DemonHunter_FanOfKnives) && !playerStatus.IsIncapacitated &&
                ...
                (iAnythingWithinRange[RANGE_15] >= 4 || ElitesWithinRange[RANGE_15] >= 1) &&
            ...
            if (!bOOCBuff && !playerStatus.IsIncapacitated && Hotbar.Contains(SNOPower.DemonHunter_SpikeTrap) &&
                ...
                (ElitesWithinRange[RANGE_30] >= 1 || iAnythingWithinRange[RANGE_25] > 4 || ((CurrentTarget.IsEliteRareUnique || CurrentTarget.IsTreasureGoblin || CurrentTarget.IsBoss) && CurrentTarget.RadiusDistance <= 35f)) &&
            ...
            if (!bOOCBuff && Hotbar.Contains(SNOPower.DemonHunter_Caltrops) && !playerStatus.IsIncapacitated &&
                playerStatus.Discipline >= 6 && (iAnythingWithinRange[RANGE_30] >= 2 || ElitesWithinRange[RANGE_40] >= 1) &&
