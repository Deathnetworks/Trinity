...
namespace Trinity
{
    public class CacheData
    {
        ...
        /// </summary>
        internal static Dictionary<int, MonsterType> dictionaryStoredMonsterTypes = new Dictionary<int, MonsterType>();

        /// <summary>
        /// Special cache for Monster sizes {ActorSNO, MonsterSize}
        /// </summary>
        internal static Dictionary<int, MonsterSize> dictionaryStoredMonsterSizes = new Dictionary<int, MonsterSize>();
      
        /// <summary>
        /// Caches the ObjectType of each object as we find it (RactorGUID based)
        /// </summary>
        internal static Dictionary<int, GObjectType> objectTypeCache = new Dictionary<int, GObjectType>();
        /// <summary>
        /// Caches monster affixes for the monster ID, as this value can be a pain to get and slow (RactorGUID based)
        /// </summary>
        internal static Dictionary<int, MonsterAffixes> unitMonsterAffixCache = new Dictionary<int, MonsterAffixes>();
        /// <summary>
        /// Caches each monster's max-health, since this never changes (RactorGUID based)
        /// </summary>
        internal static Dictionary<int, double> unitMaxHealthCache = new Dictionary<int, double>();
        /// <summary>
        /// Caches each monster's current health for brief periods  (RactorGUID based)
        /// </summary>
        internal static Dictionary<int, double> currentHealthCache = new Dictionary<int, double>();
        internal static Dictionary<int, int> currentHealthCheckTimeCache = new Dictionary<int, int>();
        /// <summary>
        ...
        /// </summary>
        internal static Dictionary<int, bool> unitBurrowedCache = new Dictionary<int, bool>();
        /// <summary>
        /// Store Actor SNO for each object (RactorGUID based)
        /// </summary>
        internal static Dictionary<int, int> actorSNOCache = new Dictionary<int, int>();
        /// <summary>
        /// Store ACDGUID for each object (RactorGUID based)
        /// </summary>
        internal static Dictionary<int, int> ACDGUIDCache = new Dictionary<int, int>();
        /// <summary>
        /// Store internal name for each object (RactorGUID based)
        /// </summary>
        internal static Dictionary<int, string> nameCache = new Dictionary<int, string>();
        /// <summary>
        /// Store Collision-sphere radius for each object (SNO based)
        /// </summary>
        internal static Dictionary<int, float> collisionSphereCache = new Dictionary<int, float>();
        /// <summary>
        ...
        /// </summary>
        internal static Dictionary<int, int> gameBalanceIDCache = new Dictionary<int, int>();
        /// <summary>
        /// Caches the Dynamic ID for each object (only used for non-units) (RactorGUID based)
        /// </summary>
        internal static Dictionary<int, int> dynamicIDCache = new Dictionary<int, int>();
        /// <summary>
        /// Caches the position for each object (only used for non-units, as this data is static so can be cached) (RactorGUID based)
        /// </summary>
        internal static Dictionary<int, Vector3> positionCache = new Dictionary<int, Vector3>();
        /// <summary>
        /// Same as above but for gold-amount of pile (RactorGUID based)
        /// </summary>
        internal static Dictionary<int, int> goldAmountCache = new Dictionary<int, int>();
        ///// <summary>
        ...
        ///// </summary>
        internal static Dictionary<int, ItemQuality> itemQualityCache = new Dictionary<int, ItemQuality>();
        /// <summary>
        /// Same as above but for whether we want to pick it up or not (RactorGUID based)
        /// </summary>
        internal static Dictionary<int, bool> pickupItemCache = new Dictionary<int, bool>();
        /// <summary>
        /// How many times the player tried to interact with this object in total
        /// </summary>
        internal static Dictionary<int, int> interactAttemptsCache = new Dictionary<int, int>();
        /// <summary>
        /// Summoned-by ID for units (RactorGUID based)
        /// </summary>
        internal static Dictionary<int, int> summonedByACDIdCache = new Dictionary<int, int>();
        ...
        /// </summary>
        internal static Dictionary<int, bool> hasBeenNavigableCache = new Dictionary<int, bool>();
        ...
        /// </summary>
        internal static Dictionary<int, bool> hasBeenRayCastedCache = new Dictionary<int, bool>();
        ...
        /// </summary>
        internal static Dictionary<int, bool> hasBeenInLoSCache = new Dictionary<int, bool>();

        /// <summary>
        /// Stores the computed ItemQuality from an ACDItem.ItemLink
        /// </summary>
        internal static Dictionary<int, ItemQuality> itemLinkQualityCache = new Dictionary<int, ItemQuality>();
